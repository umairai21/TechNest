        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <form action="{{url('/update_product_confirm',$product->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="labels">
                    <label id="protit">Product Title :</label>
                    <input type="text" class="inputcate" name="title" placeholder="Product Title" required="" value="{{$product->title}}"><br>

                    <label id="protit">Product Description :</label>
                    <input type="text" class="inputcate" name="description" placeholder="Product Description" required="" value="{{$product->description}}"><br>

                    <label id="protit">Product Price :</label>
                    <input type="number" class="inputcate" name="price" placeholder="Product Price" required="" value="{{$product->price}}"><br>

                    <label id="protit">Discounted Price :</label>
                    <input type="number" class="inputcate" name="dis_price" placeholder="-" value="{{$product->discount_price}}"><br>

                    <label id="protit">Product Quantity :</label>
                    <input type="number" class="inputcate" name="quantity" placeholder="Product Quantity" required="" value="{{$product->quantity}}"><br>

                    <label id="protit">Product Category :</label>
                    <select class="inputcate" name="category" required="">
                    ...
                    <label id="protit">Current Product Image :</label>
                    <img height="150px" width="150px" src="/product/{{$product->image}}"><br>

                

                    <label id="protit">Change Product Image :</label>
                    <input type="file" class="inputcate" name="image" ><br>

                    <input type="submit" id="btn_category" value="Update Product" class="btn btn-primary" onclick="return confirm('are you sure to update this?')">
            </form>
