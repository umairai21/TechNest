          ...
          <div class="content-wrapper">
            ...
            <form action="{{url('add_product')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="labels">
                    ...
                    <input type="text" class="inputcate" name="title" placeholder="Product Title" required=""><br>

                    <label id="protit">Product Description :</label>
                    <input type="text" class="inputcate" name="description" placeholder="Product Description" required=""><br>

                    <label id="protit">Product Price :</label>
                    <input type="number" class="inputcate" name="price" placeholder="Product Price" required=""><br>

                    <label id="protit">Discounted Price :</label>
                    <input type="number" class="inputcate" name="dis_price" placeholder="Discount, if applicable"><br>

                    <label id="protit">Product Quantity :</label>
                    <input type="number" class="inputcate" name="quantity" placeholder="Product Quantity" required=""><br>
                    ...
                    <div class="form-group row">
                     <label class="col-md-4 col-form-label text-md-right">Select Branches:</label>
                    ...
                    <label id="protit">Product Image</label>
                    <input type="file" class="inputcate" name="image" required=""><br>

                    <input type="submit" id="btn_category" value="Add Product" class="btn btn-primary" onclick="return confirm('Product has been added successfully')">
            </form>
