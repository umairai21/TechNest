          ...
          <div class="content-wrapper">
            ...
            <table class="center" style="width:100%">
                ...
                <tr>
                    ...
                    <td id="delete" style="margin-top:40px;">
                        <a href="{{url('delete_product',$product->id)}}" class="btn btn-danger" onclick="return confirm('Are you sure to delete this?')">Delete</a></td>
                    <td id="delete" style="margin-top:40px;">
                        <a href="{{url('update_product',$product->id)}}" class="btn btn-success" >Edit</a></td>
                </tr>
                @endforeach
            </table>
          </div>
