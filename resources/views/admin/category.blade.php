      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <form action="{{url('add_category')}}" method="post" class="add_category">
                @csrf
                <input type="text" class="inputcate" name="category" placeholder="Category Name">
                <input type="submit" id="btn_category" class="btn btn-primary" name="submit" value="Add Category" onclick="return confirm('Category has been added successfully')">
            </form>
            <table class="center">
              ...
              <tr>
                ...
                <td><a onclick="return confirm('Are you sure to delete this?')" class="btn btn-danger" href="{{url('delete_category',$data->id)}}" id="delete">Delete</td>
              </tr>
