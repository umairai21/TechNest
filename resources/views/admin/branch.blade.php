        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="div_center">
                <h1 class="h2_font">Add Branches</h1>
            </div>
           
            <form action="{{url('add_branch')}}" method="POST" >
                @csrf
                <input type="text" class="inputcate" name="branch" placeholder="Branch Name">
                <input type="submit" id="btn_category" class="btn btn-primary" name="submit" value="Add Branch" onclick="return confirm('Branch has been added successfully')">
            </form>
            <table class="center">
