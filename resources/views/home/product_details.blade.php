...
<body class="page-index">
  ...
  <div class="details">
    ...
    <div class="col-sm-6 col-md-4 col-lg-3" style="width:50%;">
                        <div class="img-box" style="padding-bottom:35px;">
                            <img src="product/{{$product->image}}"  alt="" height="200px" width="200px">
                        </div>
                        <div class="detail-box">
                            ...
                            <div class="col-md-4" style="margin-left: 20px;margin-top:12px;">
                            ...
                            <form action="{{url('add_cart',$product->id)}}" method="post" >
                              ...
                              <div class="row">
                                 <div class="col-md-4">
                                    <input type="number" name="quantity" value="1" min="1" style="width:100px;margin-top: 15px;">
                                 </div>
                                 <div class="col-md-4">
                                     <input type="submit" value="Add To Cart" style="border-radius: 30px;font-size:15px;margin-left:40px;margin-top: 15px;">
                                 </div>
                              </div>
                           </form>
